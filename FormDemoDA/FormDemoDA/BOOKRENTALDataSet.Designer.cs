...
namespace FormDemoDA {
    ...
    public partial class BOOKRENTALDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string UserID, string FullName, string UserName, string Password, string Phone, string Email, string Status, string Description) {
...
namespace FormDemoDA.BOOKRENTALDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([UserID], [FullName], [UserName], [Password], [Phone], [Email], [Status], [Description]) VALUES (@UserID, @FullName, @UserName, @Password, @Phone, @Email, @Status, @Description);
SELECT UserID, FullName, UserName, Password, Phone, Email, Status, Description FROM Users WHERE (UserID = @UserID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [UserID] = @UserID, [FullName] = @FullName, [UserName] = @UserName, [Password] = @Password, [Phone] = @Phone, [Email] = @Email, [Status] = @Status, [Description] = @Description WHERE (([UserID] = @Original_UserID) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Original_FullName)) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT UserID, FullName, UserName, Password, Phone, Email, Status, Description FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FormDemoDA.Properties.Settings.Default.BOOKRENTALConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, FullName, UserName, Password, Phone, Email, Status, Description FR" +
                "OM dbo.Users";
        ...
        public virtual int Delete(string Original_UserID, string Original_FullName, string Original_UserName, string Original_Password, string Original_Phone, string Original_Email, string Original_Status, string Original_Description) {
        ...
        public virtual int Insert(string UserID, string FullName, string UserName, string Password, string Phone, string Email, string Status, string Description) {
            if ((UserID == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, string UserName, string Password, string Phone, string Email, string Status, string Description, string Original_UserID, string Original_FullName, string Original_UserName, string Original_Password, string Original_Phone, string Original_Email, string Original_Status, string Original_Description) {
            return this.Update(Original_UserID, FullName, UserName, Password, Phone, Email, Status, Description, Original_UserID, Original_FullName, Original_UserName, Original_Password, Original_Phone, Original_Email, Original_Status, Original_Description);
        }
    }
